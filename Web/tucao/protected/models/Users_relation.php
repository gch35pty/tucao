...
/**
 * This is the model class for table "Users_relation".
 *
 * The followings are the available columns in table 'Users_relation':
 * @property integer $ID
 ...
 */
class Users_relation extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Users_relation', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return Users_relation the static model class
	 */
