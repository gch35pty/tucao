...
/**
 * This is the model class for table "Tucao_pic".
 *
 * The followings are the available columns in table 'Tucao_pic':
 ...
 */
class Tucao_pic extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		return new CActiveDataProvider('Tucao_pic', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return Tucao_pic the static model class
	 */
