...
/**
 * This is the model class for table "tc_topic".
 *
 * The followings are the available columns in table 'tc_topic':
 ...
 */
class tc_topic extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		return new CActiveDataProvider('tc_topic', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return tc_topic the static model class
	 */
