...
/**
 * This is the model class for table "tc_tucao_support".
 *
 * The followings are the available columns in table 'tc_tucao_support':
 ...
 */
class tc_tucao_support extends CActiveRecord
{
	/**
	...
	public function search()
	{
		...
		return new CActiveDataProvider('tc_tucao_support', array(
			'criteria'=>$criteria,
		));
	}
	 ...
	 * @return tc_tucao_support the static model class
	 */
